...
// Create the map object with center and zoom level add the center for Toronto .
let map = L.map('mapid', {
  center: [43.7, -79.3],
  zoom: 11,
  layers: [streets]
...
let torontoHoods = "https://raw.githubusercontent.com/LucyPill/Mapping-Earthquakes/main/torontoNeighborhoods.json";
